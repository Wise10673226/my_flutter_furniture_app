        ...
        children: [
          Column(
            children: [
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/wardrope.png'))),
                            ),
                            Text(
                              'Wardrobe',
                              style: TextStyle(fontFamily: 'Quicksand'),
              ...
              itemCard('FinnNavian', 'assets/ottoman.png', false),
              itemCard('FinnNavian', 'assets/anotherchair.png', true),
              itemCard('FinnNavian', 'assets/chair.png', true)

              //the end of that nice horizontal stack
            ],
          )
        ],
      ),
            ...
            Column(
              children: <Widget>[
                ...
                Container(
                  width: 175.0,
                  child: Text(
                    'Scandinavian small sized double sofa  ',
